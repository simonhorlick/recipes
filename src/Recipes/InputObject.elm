...
module Recipes.InputObject exposing (..)
...
import Recipes.Enum.Ingredients_constraint
import Recipes.Enum.Ingredients_update_column
import Recipes.Enum.Order_by
import Recipes.Enum.Recipes_constraint
import Recipes.Enum.Recipes_update_column
...
type alias Ingredients_aggregate_order_byOptionalFields =
    ...
    , count : OptionalArgument Recipes.Enum.Order_by.Order_by
...
type alias Ingredients_avg_order_byOptionalFields =
    { amount : OptionalArgument Recipes.Enum.Order_by.Order_by
    , id : OptionalArgument Recipes.Enum.Order_by.Order_by
    , recipe : OptionalArgument Recipes.Enum.Order_by.Order_by
    }
...
encodeIngredients_avg_order_by input =
    Encode.maybeObject
        [ ( "amount", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.amount ), ( "id", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.id ), ( "recipe", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.recipe ) ]
...
type alias Ingredients_inc_inputOptionalFields =
    { amount : OptionalArgument Recipes.ScalarCodecs.Numeric
...
encodeIngredients_inc_input input =
    Encode.maybeObject
        [ ( "amount", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.amount ), ( "id", Encode.int |> Encode.optional input.id ), ( "recipe", Encode.int |> Encode.optional input.recipe ) ]
...
encodeIngredients_insert_input (Ingredients_insert_input input) =
    Encode.maybeObject
        [ ( "additional_information", Encode.string |> Encode.optional input.additional_information ), ( "amount", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.amount ), ( "amount_unit", Encode.string |> Encode.optional input.amount_unit ), ( "id", Encode.int |> Encode.optional input.id ), ( "name", Encode.string |> Encode.optional input.name ), ( "recipe", Encode.int |> Encode.optional input.recipe ), ( "recipeByRecipe", encodeRecipes_obj_rel_insert_input |> Encode.optional input.recipeByRecipe ) ]
...
type alias Ingredients_max_order_byOptionalFields =
    { additional_information : OptionalArgument Recipes.Enum.Order_by.Order_by
    , amount : OptionalArgument Recipes.Enum.Order_by.Order_by
    , amount_unit : OptionalArgument Recipes.Enum.Order_by.Order_by
    , id : OptionalArgument Recipes.Enum.Order_by.Order_by
    , name : OptionalArgument Recipes.Enum.Order_by.Order_by
    , recipe : OptionalArgument Recipes.Enum.Order_by.Order_by
    }
...
encodeIngredients_max_order_by input =
    Encode.maybeObject
        [ ( "additional_information", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.additional_information ), ( "amount", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.amount ), ( "amount_unit", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.amount_unit ), ( "id", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.id ), ( "name", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.name ), ( "recipe", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.recipe ) ]
...
type alias Ingredients_on_conflictRequiredFields =
    { constraint : Recipes.Enum.Ingredients_constraint.Ingredients_constraint
    , update_columns : List Recipes.Enum.Ingredients_update_column.Ingredients_update_column
    }
...
encodeIngredients_on_conflict (Ingredients_on_conflict input) =
    Encode.maybeObject
        [ ( "constraint", Encode.enum Recipes.Enum.Ingredients_constraint.toString input.constraint |> Just ), ( "update_columns", (Encode.enum Recipes.Enum.Ingredients_update_column.toString |> Encode.list) input.update_columns |> Just ), ( "where", encodeIngredients_bool_exp |> Encode.optional input.where_ ) ]
...
encodeIngredients_set_input input =
    Encode.maybeObject
        [ ( "additional_information", Encode.string |> Encode.optional input.additional_information ), ( "amount", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.amount ), ( "amount_unit", Encode.string |> Encode.optional input.amount_unit ), ( "id", Encode.int |> Encode.optional input.id ), ( "name", Encode.string |> Encode.optional input.name ), ( "recipe", Encode.int |> Encode.optional input.recipe ) ]
...
type alias Numeric_comparison_expOptionalFields =
    { eq_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , gt_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , gte_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , in_ : OptionalArgument (List Recipes.ScalarCodecs.Numeric)
    , is_null_ : OptionalArgument Bool
    , lt_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , lte_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , neq_ : OptionalArgument Recipes.ScalarCodecs.Numeric
    , nin_ : OptionalArgument (List Recipes.ScalarCodecs.Numeric)
    }
...
encodeNumeric_comparison_exp input =
    Encode.maybeObject
        [ ( "_eq", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.eq_ ), ( "_gt", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.gt_ ), ( "_gte", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.gte_ ), ( "_in", ((Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.list) |> Encode.optional input.in_ ), ( "_is_null", Encode.bool |> Encode.optional input.is_null_ ), ( "_lt", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.lt_ ), ( "_lte", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.lte_ ), ( "_neq", (Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.optional input.neq_ ), ( "_nin", ((Recipes.ScalarCodecs.codecs |> Recipes.Scalar.unwrapEncoder .codecNumeric) |> Encode.list) |> Encode.optional input.nin_ ) ]
...
encodeRecipes_avg_order_by input =
    Encode.maybeObject
        [ ( "id", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.id ) ]
...
type alias Recipes_max_order_byOptionalFields =
    { cover_image_url : OptionalArgument Recipes.Enum.Order_by.Order_by
    , description : OptionalArgument Recipes.Enum.Order_by.Order_by
    , id : OptionalArgument Recipes.Enum.Order_by.Order_by
    , instructions : OptionalArgument Recipes.Enum.Order_by.Order_by
    , name : OptionalArgument Recipes.Enum.Order_by.Order_by
    }
...
encodeRecipes_max_order_by input =
    Encode.maybeObject
        [ ( "cover_image_url", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.cover_image_url ), ( "description", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.description ), ( "id", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.id ), ( "instructions", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.instructions ), ( "name", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.name ) ]
...
type alias Recipes_on_conflictRequiredFields =
    { constraint : Recipes.Enum.Recipes_constraint.Recipes_constraint
    , update_columns : List Recipes.Enum.Recipes_update_column.Recipes_update_column
    }
...
encodeRecipes_on_conflict (Recipes_on_conflict input) =
    Encode.maybeObject
        [ ( "constraint", Encode.enum Recipes.Enum.Recipes_constraint.toString input.constraint |> Just ), ( "update_columns", (Encode.enum Recipes.Enum.Recipes_update_column.toString |> Encode.list) input.update_columns |> Just ), ( "where", encodeRecipes_bool_exp |> Encode.optional input.where_ ) ]
...
encodeRecipes_order_by input =
    Encode.maybeObject
        [ ( "cover_image_url", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.cover_image_url ), ( "description", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.description ), ( "id", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.id ), ( "ingredients_aggregate", encodeIngredients_aggregate_order_by |> Encode.optional input.ingredients_aggregate ), ( "instructions", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.instructions ), ( "name", Encode.enum Recipes.Enum.Order_by.toString |> Encode.optional input.name ) ]
