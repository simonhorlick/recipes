...
module Recipes.Object.Ingredients_avg_fields exposing (..)
...
amount : SelectionSet (Maybe Float) Recipes.Object.Ingredients_avg_fields
amount =
    Object.selectionForField "(Maybe Float)" "amount" [] (Decode.float |> Decode.nullable)


id : SelectionSet (Maybe Float) Recipes.Object.Ingredients_avg_fields
id =
    Object.selectionForField "(Maybe Float)" "id" [] (Decode.float |> Decode.nullable)


recipe : SelectionSet (Maybe Float) Recipes.Object.Ingredients_avg_fields
recipe =
