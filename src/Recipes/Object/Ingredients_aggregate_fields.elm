...
module Recipes.Object.Ingredients_aggregate_fields exposing (..)
...
avg :
    SelectionSet decodesTo Recipes.Object.Ingredients_avg_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
avg object_ =
    Object.selectionForCompositeField "avg" [] object_ (identity >> Decode.nullable)


type alias CountOptionalArguments =
    { columns : OptionalArgument (List Recipes.Enum.Ingredients_select_column.Ingredients_select_column)
...
count :
    ...
    -> SelectionSet (Maybe Int) Recipes.Object.Ingredients_aggregate_fields
count fillInOptionals =
    let
        ...
        optionalArgs =
            [ Argument.optional "columns" filledInOptionals.columns (Encode.enum Recipes.Enum.Ingredients_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo Recipes.Object.Ingredients_max_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
max object_ =
...
min :
    SelectionSet decodesTo Recipes.Object.Ingredients_min_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
min object_ =
...
stddev :
    SelectionSet decodesTo Recipes.Object.Ingredients_stddev_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
stddev object_ =
...
stddev_pop :
    SelectionSet decodesTo Recipes.Object.Ingredients_stddev_pop_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
stddev_pop object_ =
...
stddev_samp :
    SelectionSet decodesTo Recipes.Object.Ingredients_stddev_samp_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
stddev_samp object_ =
...
sum :
    SelectionSet decodesTo Recipes.Object.Ingredients_sum_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
sum object_ =
...
var_pop :
    SelectionSet decodesTo Recipes.Object.Ingredients_var_pop_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
var_pop object_ =
...
var_samp :
    SelectionSet decodesTo Recipes.Object.Ingredients_var_samp_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
var_samp object_ =
...
variance :
    SelectionSet decodesTo Recipes.Object.Ingredients_variance_fields
    -> SelectionSet (Maybe decodesTo) Recipes.Object.Ingredients_aggregate_fields
variance object_ =
